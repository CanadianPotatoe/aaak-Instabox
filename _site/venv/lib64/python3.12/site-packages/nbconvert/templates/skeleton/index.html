...
<title>Template skeleton | DNHS Flocker</title>
...
<link rel="canonical" href="http://localhost:4100/flocker_frontend/venv/lib64/python3.12/site-packages/nbconvert/templates/skeleton/" />
<meta property="og:url" content="http://localhost:4100/flocker_frontend/venv/lib64/python3.12/site-packages/nbconvert/templates/skeleton/" />
<meta property="og:site_name" content="DNHS Flocker" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="Template skeleton" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","description":"Social Media for Del Norte High School","headline":"Template skeleton","url":"http://localhost:4100/flocker_frontend/venv/lib64/python3.12/site-packages/nbconvert/templates/skeleton/"}</script>
<!-- End Jekyll SEO tag -->
...
<main class="page-content" aria-label="Content">
  ...
  <h2 class="post-title">Template skeleton</h2>
...
<p>Do not modify the contents of the <code class="language-plaintext highlighter-rouge">../latex/skeleton</code> folder. Instead,
if you need to, make modifications to the files in this folder and then run
<code class="language-plaintext highlighter-rouge">make</code> to generate the corresponding latex skeleton files in the
<code class="language-plaintext highlighter-rouge">../latex/skeleton</code> folder.</p>
